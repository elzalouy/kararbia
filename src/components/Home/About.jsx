        ...
        <div className="row">
          <div className="col-md-5 col-md-offset-2 col-sm-6 col-xs-12">
            <div className="b-welcome__text" data-aos="fade-right">
              ...
              <ul>
                <li>
                  <span className="fa fa-check"></span>Donec facilisis velit eu
                  est phasellus consequat{" "}
                </li>
                <li>
                  <span className="fa fa-check"></span>Aenean vitae quam.
                  Vivamus et nunc nunc consequat
                </li>
                <li>
                  <span className="fa fa-check"></span>Sem vel metus imperdiet
                  lacinia enean{" "}
                </li>
                <li>
                  <span className="fa fa-check"></span>Dapibus aliquam augue
                  fusce eleifend quisque tels
                </li>
              </ul>
            </div>
          </div>
                  ...
                  <div className="b-welcome__services-support">
                    <div className="b-welcome__services-img m-support">
                      <svg
                        ...
                        height="45px"
                        viewBox="0 0 612 612"
                        enableBackground="enable-background:new 0 0 612 612;"
                      >
                        <g>
                          <path
