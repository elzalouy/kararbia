...
class Searchvehicles extends Component {
  state = {
    ...
    minYear: 2000,
    maxYear: 2020,
    manufactorerList: ["Porsh"],
    modelList: ["Lamborghini"],
  ...
  render() {
    const { manufactorerList, modelList, years } = this.state;
    return (
      <section className="b-search">
        <div className="container">
          <form action="listings.html" method="POST" className="b-search__main">
            <div className="b-search__main-title" data-aos="zoom-in-up">
              <h2>UNSURE WHICH VEHICLE YOU ARE LOOKING FOR? FIND IT HERE</h2>
            </div>
            <div className="b-search__main-type" data-aos="zoom-in-up">
              ...
              <div className="col-xs-12 col-md-10">
                <div className="row">
                  <div className="col-xs-2">
                    ...
                    <label htmlFor="type1" className="b-search__main-type-svg">
                      <div>
                        <svg
                          ...
                          enableBackground="new 47.6 310.9 500 220"
                        >
                          <g>
                            <path
                    ...
                    <h5>
                      <label htmlFor="type1">Pickup</label>
                    </h5>
                  </div>
                  <div className="col-xs-2">
                    <input
                  ...
                  <div className="col-xs-2">
                    ...
                    <h5>
                      <label htmlFor="type3">Coupe</label>
                    </h5>
                  </div>
                  <div className="col-xs-2">
                    <input
                    ...
                    <h5>
                      <label htmlFor="type4">Convertible</label>
                    </h5>
                  </div>
                  <div className="col-xs-2">
                    <input
                    ...
                    <h5>
                      <label htmlFor="type5">Sedan</label>
                    </h5>
                  </div>
                  <div className="col-xs-2">
                    <input
                    ...
                    <h5>
                      <label htmlFor="type6">Minicar</label>
                    </h5>
                  </div>
                </div>
              </div>
            </div>
            <div className="b-search__main-form" data-aos="zoom-in-up">
              <div className="row">
                <div className="col-xs-12 col-md-8">
                  <div className="m-firstSelects">
                    <div className="col-xs-4">
                      <select name="select1">
                        ...
                        {manufactorerList &&
                          manufactorerList.length > 0 &&
                          manufactorerList.map(item => (
                            <option
                              key={manufactorerList.indexOf(item)}
                              value={item}
                            >
                              {item}
                            </option>
                    ...
                    <div className="col-xs-4">
                      <select name="select2">
                        ...
                        {modelList &&
                          modelList.length &&
                          modelList.map(item => (
                            <option key={modelList.indexOf(item)} vlaue={item}>
                              {item}
                            </option>
                          ))}
                      </select>
                    ...
                    <div className="col-xs-4">
                      <select name="select3">
                        ...
                        <option defaultValue value="certified">
                          certified
                        </option>
                  ...
                  <div className="m-secondSelects">
                    <div className="col-xs-4">
                      <select name="select4">
                        <option defaultValue>Min Year</option>
                        {years &&
                          years.length > 0 &&
                          years.map(item => (
                            <option key={years.indexOf(item)} value={item}>
                              {item}
                            </option>
                          ))}
                      </select>
                    ...
                    <div className="col-xs-4">
                      <select name="select5">
                        <option defaultValue>Max Year</option>
                        {years &&
                          years.length > 0 &&
                          years.map(item => (
                            <option key={years.indexOf(item)} value={item}>
                ...
                <div className="col-md-4 col-xs-12 text-left">
                  <div className="b-search__main-form-range">
                    <div className="b-search__main-form-range-title">
